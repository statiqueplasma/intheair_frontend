(function (factory, window) {
    ...
    L.MeasureLable = L.Layer.extend({
        ...
        enableClose: function () {
            this._closeButton = L.DomUtil.create(
                "span",
                "close",
                this._container
            );
    ...
    L.MeasureAction = L.Handler.extend({
        ...
        _onMouseMove: function (event) {
            ...
            if (this._trail.points.length > 0) {
                if (this._startMove) {
                    this._directPath.setLatLngs(
                        this._trail.points.concat(latlng)
                    );
                } else {
        ...
        _enableMeasure: function () {
            ...
            if (map.options.preferCanvas) {
                ...
                console.warn(
                    "Temporarily reset map.options.prefersCanvas to false"
                );
        ...
        _getDistance: function (latlng1, latlng2) {
            ...
            var a =
                ...
                Math.cos(lat1) *
                    Math.cos(lat2) *
                    this.square(Math.sin(lng_dif / 2));
        ...
        _getAreaString: function (points) {
            ...
            return Math.round(a) < 1e6
                ...
                : this._numberFormat(
                      a / 1e6,
                      L.Measure.squareKilometersDecimals
                  ) +
                      " " +
