        ...
        <Navbare/>
                ...
                <div className="sectionServices">
                    ...
                    <ul className="services">
                        <Link  className="services-links" to="/"> 
                            <div className="case">
                                <h6 className="services-text">Energies Vertes & Environnement</h6>
                    ...
                    <ul className="services">
                        <Link  className="services-links" to="/"> 
                            <div className="case">
                                <h6 className="services-text">Immobilier & BTP</h6>
                    ...
                    <ul className="services">
                        <Link  className="services-links" to="/"> 
                            <div className="case">
                                <h6 className="services-text">Viticulture de Précision</h6>
                    ...
                    <ul className="services">
                        <Link  className="services-links" to="/"> 
                            <div className="case">
                                <h6 className="services-text">Logistique & Shipping</h6>
            ...
            <div className="contact-section" >
                ...
                <div className="contact-text">
                    ...
                    <p>Nous serions ravi d’échanger sur votre projet. Notre équipe commerciale et technique peut également vous conseiller sur votre projet</p>
